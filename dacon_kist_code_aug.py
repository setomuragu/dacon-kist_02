...
flip_result01 = pd.concat([train02, flip01_01], axis = 1)
...
flip_result03 = pd.concat([train02, flip03_01], axis = 1)

final_result05 = pd.concat([result03, flip_result01, flip_result03])
...
submission.iloc[:, 1] = a
submission.to_csv('E:/dacon_data/kist/sample_submission_10.csv',index=False)
